	...
	<div class="row">
		<div style="margin:auto;width:600px;">
			<div class="greyrow borderbox">
				<form class="form-horizontal" method="post" action="index.php?user-app-register">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="inputUsername" type="text" name="args[username]"/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="inputEmail">电子邮箱</label>
							<div class="controls">
								<input id="inputEmail" type="text" name="args[useremail]"/>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="inputRePassword" type="password" name="args[userpassword]"/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="randCode"><a href="index.php?user-app-login">用户登陆</a></label>
							<div class="controls">
